...
/**
 * @author Jonas Wålslen, jwi@kth.se.
...
public class NineMenMorrisRules implements Serializable {
    ...
    private static NineMenMorrisRules instance;

    public static NineMenMorrisRules getInstance(){
        if(instance==null)
            instance=new NineMenMorrisRules();
        return instance;
    }

    public static void  setInstance(NineMenMorrisRules in) {
       instance = in;
    }
    ...
    public void loadGame(Context context, String fileName) throws IOException, ClassNotFoundException {
        FileInputStream fileInputStream = context.openFileInput(fileName);
        ObjectInputStream objectInputStream = new ObjectInputStream(fileInputStream);
        instance = (NineMenMorrisRules) objectInputStream.readObject();
    }

    public void saveGame(Context context, String fileName) throws IOException {
